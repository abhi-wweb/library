...
export default function Chat() {
 ...
 const fetchHistory = async () => {
  try {
    const res = await fetch("https://library-api-q39x.onrender.com/history");
  ...
  const handleAsk = async () => {
    ...
    try {
      const res = await fetch("https://library-api-q39x.onrender.com/ask", {
        method: "POST",
  ...
  const handleClearHistory = async () => {
    try {
      await fetch("https://library-api-q39x.onrender.com/history", { method: "DELETE" });
      setMessages([]);
    } catch (err) {
